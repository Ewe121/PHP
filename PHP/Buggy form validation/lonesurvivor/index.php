        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-12 logo">
                    <img src="NA YOU SABI O 1.png" alt="">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row align-item-center justify-content-center">
                <div class="col-md-9 d-flex align-items-center pb-2">
                    <div class="d-flex align-items-center justify-content-start w-100">
                        ...
                        <div class="">
                            <input type="file" name="fileupload" required class="image" value="">
            ...
            <div class="row">
                ...
                <div class="col col-lg-6 col-md-6 col-12">
                    <div class="issue">
                        ...
                        <input type="radio" id="healthYes" class="healthYes" name="anyhealthcha" value="Yes" required>
                        <label for="healthYes">YES</label>
                        <input type="radio" id="healthNo" name="anyhealthcha" class="healthNo" value="No" required>
